...
Plug 'plasticboy/vim-markdown'  " markdown 语法显示高亮
Plug  'chrisbra/changesPlugin'
Plug 'hotoo/pangu.vim'
Plug 'chxuan/change-colorscheme'
Plug 'skwp/vim-easymotion'     " 文件内字符快速查找
Plug 'godlygeek/tabular'
Plug 'haya14busa/incsearch.vim'
Plug 'vim-airline/vim-airline'
Plug 'vim-airline/vim-airline-themes'
Plug 'mhinz/vim-startify'
 Plug 'mileszs/ack.vim'       " 文本内查询
Plug 'chun-yang/auto-pairs'     "在输入/删除左括号时，能自动补上/删除右括号
Plug 'chxuan/vim-edit'
" 暂时不用的插件
" Plug 'Yggdroot/LeaderF'    "搜索当前目录下的文件
...
" Plug 'tpope/vim-fugitive'  " Git包装器插件
" Plug 'tpope/vim-surround'  " 快速删除、更改和添加文本周围的匹配符号对
" Plug 'tpope/vim-commentary'
" Plug 'tpope/vim-repeat'
" Plug 'tpope/vim-endwise'
" Plug 'octol/vim-cpp-enhanced-highlight'
" Plug 'ryanoasis/vim-devicons'  " 添加文件类型图标
" Plug 'junegunn/vim-slash'  " vim-slash加强缓冲的搜索体
...
" Plug 'rhysd/clever-f.vim'   " 扩展f F t T的应用
